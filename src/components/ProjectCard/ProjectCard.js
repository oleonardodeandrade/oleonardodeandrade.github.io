...
const assets = {
    "Hamburgueria": <ImageHolder primarySource={Asset.Hamburgueria} secondarySource={Asset.FallbackHamburgueria} alt="Hamburgueria" className="card-img"/>,
    "Metaversol": <ImageHolder primarySource={Asset.Metaversol} secondarySource={Asset.FallbackMetaversol} alt="Metaversol" className="card-img"/>,
}
